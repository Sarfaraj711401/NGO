  ...
  return (
    <div style={styles.card}>
      ...
      <p style={styles.subText}>
        Please sign in to your account and join the Astha Didi Project
      </p>
      ...
      <form onSubmit={handleSubmit}>
        <div style={styles.formGroup}>
          ...
          >
            ...
            {roles.map((r) => (
              <option key={r.UserInfoId} value={r.UserType}>
                {r.UserType}
              </option>
            ))}
          </select>
  ...
  return (
    <div style={styles.card}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={styles.checkboxContainer}>
          ...
          <label htmlFor="terms" style={styles.checkboxLabel}>
            I agree to{" "}
            <span style={styles.linkText}>privacy policy & terms</span>
          </label>
        </div>
      ...
      <p style={styles.footerText}>
        ...
        <span onClick={onToggleView} style={styles.footerLink}>
          Sign in instead
        </span>
      </p>
    </div>
