...
export const DUMMY_AVATAR =
  "https://api.dicebear.com/8.x/initials/svg?seed=Rajesh&backgroundColor=696cff";
...
export const styles = {
  ...
  input: (hasError) => ({
    padding: "10px 14px",
    borderRadius: "4px",
    border: hasError ? "1px solid #ff3e1d" : "1px solid #d9dee3",
    fontSize: "0.9375rem",
    color: "#697a8d",
    outline: "none",
    backgroundColor: "#fff",
